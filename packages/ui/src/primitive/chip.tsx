...
const styles = stylex.create({
  ...
  action: {
    borderColor: {
      default: `color-mix(in oklch, ${tokens.foreground} 7%, transparent)`,
      ":not(:disabled):hover": `color-mix(in oklch, ${tokens.foreground} 11%, transparent)`,
      ":is([data-focus-visible])": `color-mix(in oklch, ${tokens.accent} 25%, transparent)`,
    },
  },
  label: {
    minWidth: 0,
