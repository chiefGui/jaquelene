...
const draculaTheme = stylex.createTheme(colors, {
  ...
  interactive: draculaPalette.interactive,
  interactiveSubtle: draculaPalette.interactiveSubtle,
  interactiveHover: draculaPalette.interactiveHover,
  interactivePressed: draculaPalette.interactivePressed,
  interactiveSelected: draculaPalette.interactiveSelected,
  interactiveSelectedHover: draculaPalette.interactiveSelectedHover,
